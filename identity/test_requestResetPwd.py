...
def getTestData(testType):
    ...
    if testType == 'sendActive':
        ...
        testData = [
            ('sendTimes', 'email', ['lisa@gmail.com', 'lisa@gmail.com', 'lisa@gmail.com', 'lisa@gmail.com', 'lisa@gmail.com'], [2, 2, 2, 2, 4]),
            ('sendTimes', 'mobile', ['886988114889', '886988114889', '886988114889', '8860988114889', '0988114889'], [2, 2, 2, 2, 4]),
            ('sourceWrong', 'sms', ['886988114889'], [4]),
            ('mailNotExist', 'email', ['list@trulovelive.dev'], [4]),
            ('mobileNoeExist', 'mobile', ['88999114889', '8860988111889'], [4, 4])
        ]
...
class TestSendActiveCode():
    def setup_class(self):
        ...
        sqlList = ["update identity set phone_number = '0988114889', phone_country_code = '886' where login_id = 'track0050'"]
    ...
    def testSendMailOrSMS(self, scenario, source, identifier, expected):
        ...
        for i in range(len(identifier)):
            if scenario == 'mailNotExist':
                sqlList = ["truncate table identity_pwd_reset_history "]
                dbConnect.dbSetting(test_parameter['db'], sqlList)
            body = {
                "source": source,
            ...
            if i == 0:
                ...
                dbConnect.dbSetting(test_parameter['db'], sqlList)
            res = api.apiFunction(test_parameter['prefix'], '', urlName, 'post', body)
...
class TestVerify():
    ...
    def testVerifyActive(self, scenario, expected):
        ...
        if res.status_code // 100 == 2:
            ...
            restext = json.loads(res.text)
            assert restext['data']['verifiedEmail'] == 'lisa@gmail.com'
